 ...
 * Based on Appendix D of the RLM paper (arXiv:2512.24601v1).
 ...
 * - {context_type}: Type of context (e.g., "string")
 * - {context_total_length}: Total character count of context
 */
const SYSTEM_PROMPT_TEMPLATE = `You are tasked with answering a query with associated context. You can access, transform, and analyze this context interactively in a REPL environment that can recursively query sub-LLMs, which you are strongly encouraged to use as much as possible. You will be queried iteratively until you provide a final answer.
 ...
 *
 * @param contextLength - Total length of the context in characters
 * @param contextType - Type of context (default: "string")
...
export function formatSystemPrompt(
  ...
  return SYSTEM_PROMPT_TEMPLATE
    ...
    .replace('{context_total_length}', String(contextLength));
}

/**
 * The raw system prompt template.
